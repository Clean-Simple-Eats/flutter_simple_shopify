...
class _$_Product extends _Product {
  _$_Product(
      ...
      : _productVariants = productVariants,
        ...
        _sellingPlanGroups = sellingPlanGroups,
        super._();
  ...
  @override
  final String? handle;
  final List<SellingPlanGroup> _sellingPlanGroups;
  @override
  @JsonKey()
  List<SellingPlanGroup> get sellingPlanGroups {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_sellingPlanGroups);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._sellingPlanGroups, _sellingPlanGroups));
  }
  ...
  int get hashCode => Object.hashAll([
        ...
        descriptionHtml,
        handle,
        const DeepCollectionEquality().hash(_sellingPlanGroups)
      ]);
...
abstract class _Product extends Product {
  factory _Product(
      ...
      final String? descriptionHtml,
      final String? handle,
      final List<SellingPlanGroup> sellingPlanGroups}) = _$_Product;
  _Product._() : super._();
